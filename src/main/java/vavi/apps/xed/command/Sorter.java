...
public class Sorter implements Command, Binder<App> {
    ...
    public void bind(App bean, String[] args, Context context) {
        ...
        bean.sorter.ascend = args.length == 2 || !args[2].equals("desc");
...
//System.err.println("nodeList: " + nodeList.getLength());
            ...
            for (int i = 0; i < nodeList.getLength(); i++) {
                ...
                String key = (String) xPath.evaluate(keyXPath, node, XPathConstants.STRING); // works well cause "removeChild" before.
